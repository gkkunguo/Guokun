package com.example.helenkellercompute.guokun.androidview.videobarrage;
...
public class DanmakuView extends View {
    ...
    private int mMaxRow = 50; //最多几条弹道
    private int mPickItemInterval = 1000;//每隔多长时间取出一条弹幕来播放.
    private int mMaxRunningPerRow = 5; //每条弹道上最多同时有几个弹幕在屏幕上运行
